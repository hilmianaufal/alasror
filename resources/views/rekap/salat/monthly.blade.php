...
@section('title', 'Rekap Salat Bulanan')
@section('mobile_title', 'Salat Bulanan')

@section('content')

<x-ui.page-header
    title="Rekap Salat Bulanan"
...
<div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    ...
    <x-ui.button
        :href="route('rekap.prayer-summary.export.excel', ['period' => 'monthly'] + request()->query())"
        variant="secondary"
