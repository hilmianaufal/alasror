...
@section('title', 'Rekap Keseluruhan Salat')
@section('mobile_title', 'Rekap Salat')

@section('content')

<x-ui.page-header
    title="Rekap Keseluruhan Salat"
    subtitle="Rekap semua salat dalam satu hari"
...
<div class="mb-6 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
    ...
    <x-ui.button
        :href="route('rekap.prayer-summary.export.excel', ['period' => 'daily'] + request()->query())"
        variant="secondary"
        ...
        <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div>
                <div class="text-lg font-black text-slate-900">
                    Detail Rekap Keseluruhan Salat
                </div>
